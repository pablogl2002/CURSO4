(define (problem EjercicioP2)
    ...
    (:init
        ...
        ; Ejercicio 3 
        (= (brazo-robotico almA) 2)
        (= (brazo-robotico almB) 2)
        (= (brazo-robotico almC) 2)
        ; modificacion
        (= (brazo-robotico almD) 2)
        ;(= (brazo-robotico almD) 1)

        (= (brazo-robotico almE) 2)
        (= (brazo-robotico almF) 2)
        (= (brazo-robotico almG) 2)
